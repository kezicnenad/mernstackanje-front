  ...
  return (
    <div className="container main">
      ...
      <p className="text-center">
        Obratite pažnju na pojedinosti, kao na primjer, za početak se koristi Google OAuth2 autorizacija korisnika. Zatim imamo fiktivni Web Shop koji artikle fetcha sa Backend servera u obliku REST API-ja, tako da je tu pokriven rad sa API-jima, potom se u tom fake Web Shopu koristi paket Stripe, kojim dobijamo mogućnost online kartičnog plaćanja, tipično za Web Shopove
        Dva ključna faktora za izradu ove aplikacije edukacija sebe i po
